...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="../../dist/img/bubonic-plague.png" class="img-circle elevation-2" alt="User Image"
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/sen_template/page/admin/upload.php") { ?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/sen_template/page/admin/notes.php") { ?>
            ...
            <?php } else { ?>
              ...
              <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/sen_template/page/admin/concern.php") { ?>
            <a href="concern.php" class="nav-link active">
            <?php } else { ?>
              <a href="concern.php" class="nav-link">
              <?php } ?>
